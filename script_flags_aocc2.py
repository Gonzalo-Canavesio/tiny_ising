...
O_LIST = [
    "-Ofast -march=native",
    "-Ofast -march=native -unroll-loops",
    "-Ofast -march=native -flto",
    "-Ofast -march=native -unroll-loops -flto",
    "-Ofast -ffast-math -march=native",
    "-Ofast -ffast-math -march=native -unroll-loops",
    "-Ofast -ffast-math -march=native -flto",
    "-Ofast -ffast-math -march=native -unroll-loops -flto",
]
